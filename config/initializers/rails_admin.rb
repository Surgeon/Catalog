# RailsAdmin config file. Generated on October 18, 2012 17:11
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Category', 'Company', 'NewsItem', 'Region', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Company', 'NewsItem', 'Region', 'User']
  ...
  #     configure :gis_id, :string 
  #     configure :rand_company, :string 
  #     configure :rand_city, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :randomized, :boolean 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your news_item.rb model definition
